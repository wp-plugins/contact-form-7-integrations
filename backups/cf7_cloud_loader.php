			...
			jQuery(document).ready(function(){
				...
				function new_tr(tr_num){
					var new_row ='<tr id="row_'+tr_num+'">'+
				      	  	  '<td>'+
				      	  	  	'Specify CF7 custom field name(without [ ]):<br />'+
				      	  	  	'<input type="text" name="cf7cloud_custom_field_name[]" id="cf7cloud_custom_field_name" value="" placeholder="paste CF7  field name" />'+
				      	  	  '</td>'+
				      	  	  '<td>'+
			    ...
			    jQuery('#map_button').on('click', function( event ){
                    ...
                    //var theJson = jQuery.getJSON(data);
                        var current_options = '<select name="cf7cloud_custom_field_select[]">';
				...
				<table id="cf7_cloud_table">
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td><input type="text" name="cf7cloud_name" id="cf7cloud_name" value="<?php echo (count($the_data) > 0)?$the_data['Full_Name']:""; ?>" placeholder="paste CF7 field NAME" data-title="Copy and Paste Contact Form 7 input name for NAME" /></td>
				    </tr>
		
				    <tr>
				      <td>Input name for EMAIL field:</td>
				      <td><input type="text" name="cf7cloud_email" id="cf7cloud_email" value="<?php echo (count($the_data) > 0)?$the_data['Email']:""; ?>" placeholder="paste CF7  field EMAIL" data-title="Copy and Paste Contact Form 7 input name for EMAIL" /></td></tr>
				    <tr>
				      <td>Specify input name for PHONE field:</td>
				      <td><input type="text" name="cf7cloud_phone" id="cf7cloud_phone" value="<?php echo (count($the_data) > 0)?$the_data['Primary_Phone']:""; ?>" placeholder="paste CF7 field PHONE" data-title="Copy and Paste Contact Form 7 input name for PHONE" /><a name="new_customs"></a>
				      </td>
				    </tr>
				    <tr>
