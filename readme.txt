...
This plugin extension is built for professional websites using Contact Form 7 and manages form submissions and leads generated from your CF7 forms. Contact Form 7 Integrations will:
...
* Post your contact form submissions to popular third-party software such as **MailChimp**, **Constant Contact**, **Zendesk**, **Google Docs** and **20+** other software partners.
...
c)	Once done, you’ll be able to manage your submission notifications, your software integrations and track your analytics.
...
Go to [Installation](http://help.contactus.com/hc/en-us/articles/200918046-Installing-the-CF7-Integrations-Plugin "Contact Form 7 Integrations installation instructions") to see a Plugin installation tutorial video.
...
In addition, for advanced users, Contact Form 7 Integrations supports less common data posts that can be used by more advanced users for lead management or source tracking purposes:
...
* UTM_Campaign (for Google web analytics)
* UTM_Term (for Google web analytics)
...
With the Contact Form 7 Integrations plugin, ContactUs.com has built API integrations into some of the leading CRM, email marketing and support software providers commonly used by small businesses and organizations for managing their contact form submissions.  Using pre-built APIs, each integration provides all of the input fields necessary for ContactUs.com to connect with your account with each respective software. Some of the supported software includes:
...
Learn more about ContactUs.com and our efforts to make smarter, more effective contact forms at our website.
...
**What if I just want to integrate my email marketing software with a form?**

* You can do that with Contact Form by ContactUs.com. It comes enabled with the same third party integration options. 
...
**How do I access the contact form submissions from ContactUs.com?**

* When installing the plugin, you will be prompted to create a free ContactUs.com account. With the same username and password you created, please log in to http://www.contactus.com/login.
